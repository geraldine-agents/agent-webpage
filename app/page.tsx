      ...
      <header className="w-full max-w-[960px] mx-auto mb-20 fade-in">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-start">
          ...
          <div className="flex flex-col">
            ...
            {/* Skills — marquee */}
            {(() => {
              const skills = ["LangChain", "LangGraph", "Groq", "Gemini", "RAG", "Agentic Loops", "Python", "TypeScript", "MLOps", "AWS", "FastAPI", "Spark"];
              return (
                <div className="marquee-container mb-7">
                  <div className="marquee-track">
                    {[...skills, ...skills].map((skill, i) => (
                      <span
                        key={i}
                        className="inline-block px-[10px] py-[4px] text-[0.75rem] rounded-[6px] bg-white/[0.05] text-[#a1a1aa] border border-white/[0.08] mr-2 whitespace-nowrap"
                      >
                        {skill}
                      </span>
                    ))}
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <a
                href="#cv"
                className="flex items-center gap-2 px-4 py-2 border border-white/[0.15] hover:border-white/[0.3] hover:bg-white/[0.04] text-[#e2e8f0] text-[0.85rem] font-medium rounded-lg transition-colors duration-200"
              >
                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
