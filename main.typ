...
#subheading[AI Solutions Consultant][Jun 2023 -- Present][Specializing in Agentic AI & ML Solutions][]
...
gap-before: -6pt,
gap-after: -6pt,
[AI Engineering: Agentic Workflows (ReAct, LangChain, OpenClaw, LangGraph), Multi-agent Orchestration, Llama, Groq, Gemini, Vector Databases & RAG, Function Calling, Tool Use, LLM Evaluation, Prompt Injection Prevention.],
...
#subheading[Master of Science in Data Science (Specialization in NLP)][2024 -- Present][Benemérita Universidad Autónoma de Puebla (BUAP)][GPA: 9.7/10.0]
